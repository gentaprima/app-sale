            ...
            <table class="table table-bordered">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>{{$row->price}}</td>
                  <td>
                    <center><a href="" data-target="#modalPhoto" onclick="seePhoto(`{{asset('uploads/product/')}}`,`{{$row->image}}`)" data-toggle="modal" class="btn btn-outline-success btn-sm">Lihat foto</a>
                  </td>
                  </center>
                  <td>
                    <center>
                      <span data-toggle="modal" data-target="#modalForm">
                        <button id="btn_verif" onclick="updateData('{{$row->id}}','{{$row->product_name}}','{{$row->product_desc}}','{{$row->price}}','{{$row->image}}')" type="button" class="btn btn-inverse-success btn-rounded btn-icon" data-toggle="tooltip" data-placement="top" title="Ubah Data Produk">
