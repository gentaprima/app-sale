...
<div class="content-wrapper">
  <div class="page-header">
    <h3 class="page-title">Data Transaksi Non Member Bulan {{$month}}</h3>
          ...
          <div class="table-responsive">
            <div class="d-flex align-items-center">
              <div class="input-group">
                ...
                @php }else{ @endphp
                <a href="/dashboard/data-transaction-member" class="btn btn-primary size-btn mx-1"><i class="fa fa-filter"></i>Reset Filter</a>
                @php } @endphp
              </div>
            ...
            <table id="table" class="table table-striped dataTable js-basic-example mt-3">
              <thead>
                <tr>
                  <th> # </th>
                  <th> ID Order </th>
...
<script>
  ...
  function detailOrder(id) {
    ...
    $.ajax({
      dataType: 'html',
      type: 'get',
      url: `/dashboard/get-detail-order-non-member/${id}`,
    ...
    $.ajax({
      dataType: 'html',
      type: 'get',
      url: `/dashboard/get-detail-order-all-non-member/${id}`,
      success: function(response) {
        let data = JSON.parse(response);
        let k = 1;
