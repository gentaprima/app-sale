...
<div class="content-wrapper">
  <div class="page-header">
    <h3 class="page-title">Data Pelayan</h3>
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="/">Beranda</a></li>
        <li class="breadcrumb-item active" aria-current="page">Data Pelayan</li>
      </ol>
    </nav>
  </div>
  <div class="row">
...
<div class="modal fade" id="modalDetail" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg" style="width: 800px;">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="modalTitle">Detail Pelayan</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
...
<script>
  function addProduct() {
    ...
    document.getElementById('modalTitle').innerHTML = 'Tambah Pelayan';
    document.getElementById('form').action = '/dashboard/add-pelayan';
  }
  ...
  function updateData(id,idMember,fullName,email,phoneNumber,alamat,kecamatan,kabupaten,provinsi,photo){
    ...
    document.getElementById('form').action = `/dashboard/update-pelayan/${id}`;
  }
