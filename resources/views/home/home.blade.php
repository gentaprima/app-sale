                    ...
                    @foreach ($product as $p)
                        <div class="col-lg-3 col-md-6">
                            <div class="single-product">
                                <img class="img-fluid" src="{{ asset('uploads/product/') . '/' . $p->image }}" alt="" style="object-fit: contain;height:250px">
            ...
            <div class="row">
                ...
                <div class="col-lg-6 no-padding exclusive-right">
                    ...
                    <div class="single-exclusive-slider">
                        <img class="img-fluid" src="{{ asset('uploads/product/') . '/' . $n->image }}" alt="" style="object-fit: contain;height:250px">
                        <div class="product-details">
                            <div class="price">
